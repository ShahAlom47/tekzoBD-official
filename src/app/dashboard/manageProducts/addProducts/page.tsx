...
const AddProduct: React.FC = () => {
  ...
  return (
    <form
      ...
      className="max-w mx-auto p-6 space-y-6 min-w-[320px]"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="slug" className="block mb-1 text-sm ">
            Slug (URL friendly)
          </label>
          <input
            id="slug"
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            className="my-input min-h-16 w-full"
          />
        </div>
        ...
        <div>
          <label htmlFor="discount" className="block mb-1 text-sm ">
            Discount (%)
          </label>
          <input
            type="number"
      ...
      <div>
        <label htmlFor="sourceType" className="block mb-1 text-sm ">
          Product Source
        </label>
        <select
          id="sourceType"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
        ...
        <div>
          <label htmlFor="supplierName" className="block mb-1 text-sm ">
            Supplier Name (if dropship)
          </label>
          <input
            id="supplierName"
            type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="productSourceLink" className="block mb-1 text-sm ">
            Product Source Link
          </label>
          <input
            id="productSourceLink"
        ...
        <div>
          <label htmlFor="supplierProductId" className="block mb-1 text-sm ">
            Supplier Product ID
          </label>
          <input
        ...
        <div>
          <label htmlFor="deliveryTime" className="block mb-1 text-sm ">
            Delivery Time
          </label>
          <input
            id="deliveryTime"
        ...
        <div>
          <label htmlFor="shippingCost" className="block mb-1 text-sm ">
            Shipping Cost
          </label>
          <input
            type="number"
        ...
        <div>
          <label htmlFor="returnPolicy" className="block mb-1 text-sm ">
            Return Policy
          </label>
          <input
            id="returnPolicy"
        ...
        <div>
          <label htmlFor="commissionRate" className="block mb-1 text-sm ">
            Commission Rate (%)
          </label>
          <input
            type="number"
        ...
        <div className="flex items-center gap-2 my-input h-full rounded-sm px-2">
          <input
            ...
            className="w-5 h-5 cursor-pointer"
          />
          <label htmlFor="externalStock" className="">
            External Stock?
          </label>
        </div>
      </div>
